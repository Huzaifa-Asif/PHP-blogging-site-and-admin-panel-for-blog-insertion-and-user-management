                       ...
                       <div class="form-group">
                            <span class="input-group">
                              <span class="input-group-btn">
                               ...
                               <input type="text" class="form-control" name="subject" placeholder="Huzaifa">
                            </span>
                        </div>
                        <div class="form-group">
                            <span class="input-group">
                              <span class="input-group-btn">
                               ...
                               <input type="email" class="form-control" name="user_email" placeholder="huzaifa8580@gmail.com">
                            </span>
                        </div>
                       <div class="form-group">
